...
class Args(object):
    ...
    def set_train_args(self):
        ...
        self.parser.add_argument("--epoch", type=int, default=53, help="number of end epoch")
        ...
        self.parser.add_argument("--dataset_dir", type=str, default=r"/kaggle/input/yolov1/voc2012_forYolov1")
        self.parser.add_argument("--checkpoints_dir", type=str, default="/kaggle/working/checkpoints")
        self.parser.add_argument("--print_freq", type=int, default=20,
                            help="print training information frequency (per n iteration)")
        self.parser.add_argument("--save_freq", type=int, default=100, help="save model frequency (per n epoch)")
    ...
    def set_test_args(self):
        ...
        self.parser.add_argument("--use_GPU", action="store_true", help="identify whether to use gpu")
        self.parser.add_argument("--GPU_id", type=int, default=None, help="device id")
        self.parser.add_argument("--dataset_dir", type=str, default=r"/kaggle/input/yolov1/voc2012_forYolov1/img")
        self.parser.add_argument("--weight_path", type=str,
                            default=r"/kaggle/working/checkpoints/epoch18.pkl",
